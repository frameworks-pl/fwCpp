...
fw::core::ByteBuffer
SIAESEncDec::encrypt(const BYTE* pData, int pLen) {
  ...
  try {
    ...
    sicrypt::SICryptException e(ex.GetErrorType(), ex.GetWhat());
    throw e;
  }
...
fw::core::ByteBuffer
SIAESEncDec::decrypt(const BYTE* pData, int pLen) {
...
void
SIAESEncDec::init(BYTE* pBuffer, int pLength) {
