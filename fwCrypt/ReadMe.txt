========================================================================
    STATIC LIBRARY : sicrypt Project Overview
========================================================================

AppWizard has created this sicrypt library project for you. 
This file contains a summary of what you will find in each of the files that
make up your sicrypt application.
...
StdAfx.h, StdAfx.cpp
    ...
    named sicrypt.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "sicrypt.rc" and a "sicrypt.h" that 
